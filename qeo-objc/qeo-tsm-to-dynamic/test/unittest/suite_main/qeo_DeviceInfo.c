...
const DDS_TypeSupport_meta org_qeo_system_DeviceInfo_type[] = {
    /* Change name to avoid clash */
    { .tc = CDR_TYPECODE_STRUCT, .name = "org.qeo.system.DeviceInfo2", .flags = TSMFLAG_DYNAMIC|TSMFLAG_GENID|TSMFLAG_KEY|TSMFLAG_MUTABLE, .nelem = 9, .size = sizeof(org_qeo_system_DeviceInfo_t) },  
