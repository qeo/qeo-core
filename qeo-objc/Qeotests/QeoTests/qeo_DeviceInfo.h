...
/**
 * Information how this device is represented in the realm on the SMS.
 */
@interface org_qeo_system_RealmInfo : QEOType

  /**
   * The ID of the realm on the SMS.
   */
  @property (nonatomic) int64_t realmId;
  /**
   * The ID of the device on the SMS.
   */
  @property (nonatomic) int64_t deviceId;
  /**
   * The ID of the user on the SMS.
   */
...
@interface org_qeo_system_DeviceInfo : QEOType
   ...
   */
  @property (strong,nonatomic) org_qeo_system_RealmInfo * realmInfo;
