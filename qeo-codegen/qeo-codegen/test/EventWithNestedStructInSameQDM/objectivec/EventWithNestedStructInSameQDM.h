 ...
 */
@interface org_qeo_test_MyInnerStructWithPrimitives : QEOType
 ...
 */
@interface org_qeo_test_EventWithNestedStruct : QEOType

  @property (strong,nonatomic) org_qeo_test_MyInnerStructWithPrimitives * MyStructWithPrimitives;
  @property (nonatomic) BOOL MyBoolean;
  @property (nonatomic) int8_t MyByte;
  @property (nonatomic) int16_t MyInt16;
  @property (nonatomic) int32_t MyInt32;
