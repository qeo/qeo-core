...
static parameter_t fwd_parameters[] = {
    ...
    {QEOCORE_GROUP_TYPE_FWD, "BGNS_TCP_KEEPCNT", QEOCORE_PAR_TYPE_NUMBER, {.num = 0}},
    {QEOCORE_GROUP_TYPE_FWD, "BGNS_TCP_KEEPIDLE", QEOCORE_PAR_TYPE_NUMBER, {.num = 0}},
    {QEOCORE_GROUP_TYPE_FWD, "BGNS_TCP_KEEPINTVL", QEOCORE_PAR_TYPE_NUMBER, {.num = 0}},
};
