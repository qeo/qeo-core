    ...
    extends QeoTestCase
{
    ...
    /**
     * Try to write a state with some values missing.
     */
    public void testMissingValue()
        throws Exception
    {
        try {
            jsw.write(new JSONObject("{\"name\": \"blabla\"}")); // key fields and other fields missing
        ...
        // sleep a little to ensure this write did not succeed
        Thread.sleep(100);
        assertEquals(0, recvStatesJSON.size());
    }
}
