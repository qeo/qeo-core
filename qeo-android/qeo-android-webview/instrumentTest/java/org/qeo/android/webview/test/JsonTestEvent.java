...
import org.qeo.json.types.JsonTestEnum;
    ...
    extends JsonAndroidTestCase
{
    ...
    private static final String TD_ENUM = "{ enum: 'org.qeo.json.types.JsonTestEnum', " + "values: {"
    ...
    private static final String TD_EVENT_ARRAY =
        ...
        extends JSONObject
    {
        ...
        public TestTypesJson(long longtypeVal, int inttypeVal, short shorttypeVal, String stringtypeVal,
            byte bytetypeVal, float floattypeVal, boolean booleantypeVal, JsonTestEnum enumtypeVal)
        ...
        public TestTypesJson(long[] longArraytypeVal, int[] intArraytypeVal, short[] shortArraytypeVal,
            ...
            boolean[] booleanArraytypeVal, JsonTestEnum[] enumArraytypeVal)
        // CHECKSTYLE.ON: ParameterNumber
        {
        ...
        // CHECKSTYLE.OFF: ParameterNumber - need more than 7 to test all types
        // CHECKSTYLE.OFF: Indentation - Eclipse formatting rules can't do what Checkstyle expects
        private static Map<String, Object>
            toMap(long longtypeVal, int inttypeVal, short shorttypeVal, String stringtypeVal, byte bytetypeVal,
        ...
        private static JSONArray fromEnumArray(JsonTestEnum[] array)
        {
            JSONArray json = new JSONArray();
        ...
        throws Exception
    {
        ...
        JsonTestEnum[] enumarraytype = new JsonTestEnum[arraySize];
        ...
        try {
            ...
            for (int i = 0; i < numSamples; ++i) {
                ...
                for (int j = 0; j < arraySize; ++j) {
                    ...
                    enumarraytype[j] = JsonTestEnum.values()[j % JsonTestEnum.values().length];
                }
            ...
            for (int i = 0; i < numSamples; ++i) {
                JsonTestTypes type2 =
                    new JsonTestTypes(i * 100L, i * 10, "String " + i, (byte) i, new byte[] {1, 2, 3, 4, 5, 6, 7},
                        (float) i / 10, true, JsonTestEnum.ENUM_FIRST);
        ...
        throws Exception
    {
        ...
        JSONObject type1 =
            new TestTypesJson(1, 2, (short) 10, "type1", (byte) 3, (float) 4.5, true, JsonTestEnum.ENUM_FIRST);
        JSONObject type2 =
            new TestTypesJson(5, 6, (short) 11, "type2", (byte) 7, (float) 11.1, false, JsonTestEnum.ENUM_SECOND);
        ...
        throws Exception
    {
        ...
        try {
            ...
            JsonTestTypes type1 =
                new JsonTestTypes(1, 2, "type1", (byte) 3, new byte[] {1, 2, 3}, 4, true, JsonTestEnum.ENUM_FIRST);
            JsonTestTypes type2 =
                new JsonTestTypes(5, 6, "type2", (byte) 7, new byte[] {8, 9, 10}, 11, false, JsonTestEnum.ENUM_SECOND);
        ...
        throws Exception
    {
        ...
        try {
            ...
            JSONObject type1 = new TestTypesJson(1, 2, (short) 11, "type1", (byte) 3, 4, true, JsonTestEnum.ENUM_FIRST);
            JSONObject type2 =
                new TestTypesJson(5, 6, (short) 12, "type2", (byte) 7, 11, false, JsonTestEnum.ENUM_SECOND);
            JSONObject at = new JSONObject();
            at.put("types1", type1);
            at.put("types2", type2);
