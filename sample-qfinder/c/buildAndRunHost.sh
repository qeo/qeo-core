...
echo "LD_LIBRARY_PATH=output/gradle/qeo-sdk/c/lib/i686-linux ./output/gradle/sdk-src/sample-qfinder-c-HOSTLINUX"
LD_LIBRARY_PATH=output/gradle/qeo-sdk/c/lib/i686-linux ./output/gradle/sdk-src/sample-qfinder-c-HOSTLINUX
